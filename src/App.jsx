...
const Navigation = () => {
  ...
  const isActive = (path) => {
    return location.pathname === path ? "text-blue-400" : "text-gray-300 dark:text-gray-300";
  };
    ...
    <nav className="fixed w-full bg-white dark:bg-gray-900 shadow-sm z-50 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex">
            <Link to="/" className="flex items-center font-bold text-2xl text-gray-900 dark:text-white" >AM</Link>
          </div>

          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/" className={`${isActive('/')} hover:text-blue-400 transition-colors`}>Home</Link>
            <Link to="/about" className={`${isActive('/about')} hover:text-blue-400 transition-colors`}>About</Link>
            <Link to="/academic" className={`${isActive('/academic')} hover:text-blue-400 transition-colors`}>Academic</Link>
            <Link to="/projects" className={`${isActive('/projects')} hover:text-blue-400 transition-colors`}>Projects</Link>
            <Link to="/resume" className={`${isActive('/resume')} hover:text-blue-400 transition-colors`}>Resume</Link>
            <Link to="/tutoring" className={`${isActive('/tutoring')} hover:text-blue-400 transition-colors`}>Teaching</Link>
            <Link to="/contact" className={`${isActive('/contact')} hover:text-blue-400 transition-colors`}>Contact</Link>
            <button
        ...
        {isOpen && (
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <Link to="/" className="block px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-blue-400">Home</Link>
              <Link to="/about" className="block px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-blue-400">About</Link>
              <Link to="/academic" className="block px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-blue-400">Academic</Link>
              <Link to="/projects" className="block px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-blue-400">Projects</Link>
              <Link to="/resume" className="block px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-blue-400">Resume</Link>
              <Link to="/tutoring" className="block px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-blue-400">Teaching</Link>
              <Link to="/contact" className="block px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-blue-400">Contact</Link>
              <button
                onClick={() => setIsDark(!isDark)}
  ...
  <PageTransition>
    <div className="min-h-screen pt-16 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <motion.div
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg mx-auto max-w-7xl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <h2 className="text-3xl font-bold mb-12 text-gray-900 dark:text-white">Teaching Experience</h2>
...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      image: solarflair, // You'll need to add an image for this project
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {projects.map((project, index) => (
              <div key={index} className="w-full md:w-[calc(32.33%-1rem)]">
                <ProjectCard {...project} />
              </div>
            ))}
          </div>
    ...
    <div className="min-h-screen pt-16 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div>
            <h2 className="text-3xl font-bold mb-8 text-gray-900 dark:text-white">Currently Open To</h2>
            <div className="space-y-4">
...
const Footer = () => (
  <footer className="bg-gray-50 dark:bg-gray-800 py-6 mt-auto">
...
const CourseCard = ({ department, courses, departmentColor }) => (
  <motion.div
    initial={{ opacity: 0, y: 20 }}
    animate={{ opacity: 1, y: 0 }}
    transition={{ duration: 0.5 }}
    className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow mb-8"
  >
    <div className="flex items-center mb-6">
      <div className={`w-4 h-4 rounded-full ${departmentColor} mr-3`}></div>
      <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{department}</h3>
    </div>
        ...
        <div key={index} className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
          <div className="flex justify-between items-start">
            <div className="flex-grow">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 leading-tight">{course.name}</p>
            </div>
            <span className="text-blue-600 dark:text-blue-400 font-bold ml-2">{course.grade}</span>
          </div>
        </div>
      ))}
    </div>
...
const TestimonialCard = ({ quote, author, role, course, delay = 0 }) => (
  <motion.div
    ...
    className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-700 backdrop-blur-sm"
  >
    <div className="mb-4">
